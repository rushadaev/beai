  ...
  return (
    <section className="py-20 bg-dark">
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <SectionHeader 
          eyebrow={t('visualBuilder.header.eyebrow')}
          title={t('visualBuilder.header.title')}
        />
        ...
        <div className="rounded-xl bg-card border border-border overflow-hidden shadow-xl">
          <div className="bg-dark px-4 py-2 flex items-center">
            ...
            <div className="ml-4 text-sm text-secondary">{t('visualBuilder.windowTitle')}</div>
          </div>
          <div className="p-6 h-80 flex items-center justify-center">
            <div className="text-center text-secondary">
              ...
              <p className="text-xl font-semibold text-primary">{t('visualBuilder.placeholder.title')}</p>
              <p className="mt-2">{t('visualBuilder.placeholder.description')}</p>
            </div>
          </div>
        </div>
      </div>
