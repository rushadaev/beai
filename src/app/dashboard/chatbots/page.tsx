    ...
    <DashboardLayout>
      <div className="container mx-auto px-4 py-6">
        <div className="mb-8 flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-bold text-primary">My Chatbots</h1>
            <p className="text-secondary">Create and manage your AI chatbots</p>
          </div>
        ...
        {showCreateForm && (
          <div className="mb-6 rounded-lg border border-border bg-card p-6 shadow-sm">
            <h2 className="mb-4 text-lg font-medium text-primary">Create New Chatbot</h2>
        ...
        {isLoading ? (
          ...
          <div className="flex flex-col items-center justify-center rounded-lg border border-border bg-card p-12 shadow-sm">
            ...
            <h3 className="text-xl font-medium text-primary">No Chatbots Yet</h3>
            <p className="mb-6 text-center text-secondary">
              Create your first chatbot to start engaging with your visitors
            </p>
            <button
              onClick={() => setShowCreateForm(true)}
              className="rounded-md bg-accent px-4 py-2 text-sm font-medium text-dark hover:bg-accent/80"
                ...
                <div className="flex justify-between">
                  ...
                  >
                    ...
                    <p className="text-sm text-secondary">
                      Last updated: {formatDate(chatbot.updatedAt)}
                    </p>
                  </div>
